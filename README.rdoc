...
This will yield options with the class attribute set to user.role:
  <option value="1" class="admin">George Washington</option>
  
== See Also
((<Ruby|URL:http://api.rubyonrails.org/classes/ActionView/Helpers/FormOptionsHelper.html#method-i-options_from_collection_for_select>))
